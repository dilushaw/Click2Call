...
<html>
    <head>
        ...
        <title>Edit Charging Plan</title>
...
//            });
    ...
    <body>
        <form:form name="editChargingPlan" commandName="editChargingPlanForm" action="editChargingPlan.htm?planId=${planId}" method="POST">
            ...
            <table  border="0" align="center" cellpadding="5">
                ...
                <tr>
                    ...
                    <td><form:input  path="planName" name="planName" id="planName" disabled="${'true'}"/></td>
                </tr>
                <tr>
                    <td><label>Charging Type</label></td>
                    <td><form:hidden path="typeName" name="typeName" id="typeName" />
                        <c:choose>
                            <c:when test="${not empty chargeTypes}">

                                <form:select path='chargingTypeId' id="chargingTypeId" disabled="${'true'}">
                ...
                <tr align="center">
                    <td colspan="3">
                        <input type="submit" name="buttonSave" id="buttonSave" value="Save" class="button" onClick="return validateEditChargingPlan()">
