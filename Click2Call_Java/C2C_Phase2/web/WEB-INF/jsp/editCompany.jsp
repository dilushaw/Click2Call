...
<html>
    ...
    <body>
       <!-- <div id="Barcode"> -->
       <form:form name="editCompany" id="editCompany" commandName="editCompany" action="editCompany.htm" method="POST">
            <table  border="0" align="center" cellpadding="5">
                <tr><th colspan="2"><font color="green">${successMessage}</font></th></tr>
            <!--    <tr>
                    <td colspan="4"><div style="color:red"></div></td>
                </tr> -->
                    <td><form:hidden path="companyId" name="companyId" id="companyId" readonly="true" />
                    </td>
                    <td><form:errors path="companyId" /></td>
                <tr>
                ...
                <tr>
                    <td><B>Email*</B></td>
                    <td><form:input  path="email" name="email" id="email" maxlength="100" />
                    </td>
                    <td></td>
                </tr>
                <!-- Radio Buttons -->
                ...
                <tr>
                    ...
                    <td>From <form:input  path="startTime" id="time2" size="10" readonly="true" />
                        To <form:input path="endTime" id="time3" size="10" readonly="true"/>
                    </td>
                ...
                <tr align="center">
                    <td colspan="4">
                        <input type="submit" name="buttonSave" id="buttonSave" value="Save" class="button" onClick="return validateCompanyEditForm()">
